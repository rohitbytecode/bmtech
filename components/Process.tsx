    ...
    <section className="pt-12 md:pt-16 pb-10 md:pb-16 px-6 sm:px-12 md:px-24 bg-background overflow-hidden relative transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative md:ml-12">
          ...
          <div className="absolute left-[19px] sm:left-[27px] top-6 bottom-0 w-[2px] bg-blue-500/20"></div>
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="relative z-10 flex-shrink-0 flex items-center justify-center w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-background border-[2px] border-blue-500/30 group-hover:border-blue-500 transition-colors duration-500 mt-1 sm:mt-2">
                  <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-blue-500/50 group-hover:bg-blue-500 group-hover:shadow-[0_0_15px_rgba(0,180,255,0.8)] transition-all duration-500"></div>
                </div>
